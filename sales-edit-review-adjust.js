...
(function(){
  ...
  function itemRow(i){
    ...
    return '<div class="review-edit-item rounded-xl border bg-white p-3" data-id="'+esc(i.id||'')+'" data-kind="'+(service?'service':'product')+'" data-discount-basis="amount">'
      ...
      +'<div class="md:col-span-3"><label class="text-[9px] uppercase font-bold text-gray-400">Line Discount</label><div class="grid grid-cols-2 gap-1 mt-1"><input aria-label="Line Discount Percent" title="Discount %" placeholder="%" class="r-disc-pct w-full border rounded-lg px-2 py-2" type="number" min="0" max="100" step="0.01" value="'+linePct+'" oninput="reviewLineDiscountPercentChanged(this)"><input aria-label="Line Discount Amount" title="Discount Amount" placeholder="Amount" class="r-disc w-full border rounded-lg px-2 py-2" type="number" min="0" step="0.01" value="'+lineDisc+'" oninput="reviewLineDiscountAmountChanged(this)"></div></div>'
