  ...
  function itemRow(i=null){
    ...
    if(service){
      ...
      return `<div class="edit-order-item-row grid md:grid-cols-12 gap-2 p-3 bg-amber-50/50 border border-amber-100 rounded-xl" data-item-id="${esc(i?.id||'')}" data-linked="0" data-discount-basis="amount">
        ...
        <div class="md:col-span-3"><label class="text-[10px] font-semibold text-gray-500">Line Discount</label><div class="grid grid-cols-2 gap-1 mt-1"><input aria-label="Line Discount Percent" title="Discount %" placeholder="%" class="edit-line-discount-percent w-full border rounded-lg px-2 py-2" type="number" min="0" max="100" step="0.01" value="${lineDiscountPct}" oninput="editLineDiscountPercentChanged(this)"><input aria-label="Line Discount Amount" title="Discount Amount" placeholder="Amount" class="edit-line-discount w-full border rounded-lg px-2 py-2" type="number" min="0" step="0.01" value="${lineDiscount}" oninput="editLineDiscountAmountChanged(this)"></div></div>
    ...
    return `<div class="edit-order-item-row grid md:grid-cols-12 gap-2 p-3 bg-gray-50 rounded-xl" data-item-id="${esc(i?.id||'')}" data-linked="${linked?'1':'0'}" data-returned="${returned?'1':'0'}" data-discount-basis="amount">
      ...
      <div class="md:col-span-3"><label class="text-[10px] font-semibold text-gray-500">Line Discount</label><div class="grid grid-cols-2 gap-1 mt-1"><input aria-label="Line Discount Percent" title="Discount %" placeholder="%" ${role()==='sales'?'':(returned?'disabled':'')} class="edit-line-discount-percent w-full border rounded-lg px-2 py-2 disabled:bg-gray-100" type="number" min="0" max="100" step="0.01" value="${lineDiscountPct}" oninput="editLineDiscountPercentChanged(this)"><input aria-label="Line Discount Amount" title="Discount Amount" placeholder="Amount" ${role()==='sales'?'':(returned?'disabled':'')} class="edit-line-discount w-full border rounded-lg px-2 py-2 disabled:bg-gray-100" type="number" min="0" step="0.01" value="${lineDiscount}" oninput="editLineDiscountAmountChanged(this)"></div></div>
